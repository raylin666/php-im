...
return [
    ...
    'secret' => env('JWT_SECRET', 'raylin.micro.im'), // 非对称加密使用字符串,请使用自己加密的字符串
    ...
    'ttl' => env('JWT_TTL', 8640000), // token过期时间，单位为秒
    ...
    'blacklist_prefix' => 'raylin.jwt.micro.im', // 黑名单缓存的前缀
    ...
    'scene' => [
        'default' => [],
        'websocket' => [
            'secret' => 'raylin.micro.im', // 非对称加密使用字符串,请使用自己加密的字符串
